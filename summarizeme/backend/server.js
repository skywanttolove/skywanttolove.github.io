...
async function summarizeSchema(material, langName) {
  ...
  const blockPrompt =
    ...
    `- ในแต่ละ item ให้ครอบ "คำหรือวลีที่สำคัญที่สุด" เพียง 1 จุด ด้วยเครื่องหมาย «...» เพื่อไฮไลต์ (เช่น "«ผลคูณเชิงสเกลาร์» ให้ผลเป็นจำนวนจริง") ห้ามครอบทั้งประโยค ครอบแค่คำสำคัญสั้นๆ\n` +
